...
namespace App\Service\Validation\Validator;
...
class MonValidator extends ConstraintValidator
{
  ...
  public function validate($value, Constraint $constraint)
  {
    ...
    $isFlood = $this->em
      ...
      ->isFlood($ip, $value) // Bien entendu, il faudrait écrire cette méthode isFlood, c'est pour l'exemple
    ;
